...
public class CleanupReviewWindowSmokeTests
{
    [StaFact]
    public void CleanupReviewWindow_renders_without_binding_errors()
    {
        ...
        try
        {
            window = new CleanupReviewWindow
            {
                DataContext = new CleanupReviewWindowStubViewModel(),
